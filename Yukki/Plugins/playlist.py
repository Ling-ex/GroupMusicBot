...
@Client.on_message(command(["playlist", "playlist@Ling_Musik_Bot"]) & other_filters)
...
@Client.on_message(command(["delmyplaylist", "delmyplaylist@Ling_Musik_Bot"]) & other_filters)
...
@Client.on_message(command(["delchatplaylist", "delchatplaylist@Ling_Musik_Bot"]) & other_filters)
